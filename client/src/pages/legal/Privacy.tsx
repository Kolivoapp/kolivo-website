  ...
  const content = {
    en: {
      ...
      scope: {
        ...
        text: "This Privacy Policy applies to all personal information collected, used, or disclosed by KOLIVO™ Technologies Inc. through our websites (kolivo.ca, corporate.kolivo.ca), our platforms (HUB by KOLIVO™, Studio+ by KOLIVO™, GUARDO by KOLIVO™, PARTENARIO by KOLIVO™), and our identity service (HALO by KOLIVO™)."
      },
      responsiblePerson: {
